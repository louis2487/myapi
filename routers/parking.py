...
from routers.parking_admin import router as parking_admin_router
from routers.parking_posts import router as parking_posts_router

router.include_router(parking_admin_router)
router.include_router(parking_posts_router)
